  ...
  methods: {
    ...
    async addEvent() {
      if (this.name && this.start && this.end) {
        await this.$firestore.collection("calEvent").add({
          name: this.name,
    ...
    async updateEvent(ev) {
      await this.$firestore.collection("calEvent").doc(this.currentlyEditing).update({
        details: ev.details,
      });
      (this.selectedOpen = false), (this.currentlyEditing = null);
    },
    async deleteEvent(ev) {
      await this.$firestore.collection("calEvent").doc(ev).delete();
